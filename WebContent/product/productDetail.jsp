...
<div class="container-fluid" id="content">
			...
			<div class="btn-group">
				...
				<% if(sid != null){ %>
				<a href="<%=request.getContextPath() %>/GetSalesProductCtrl?proNo=<%=vo.getProNo() %>" class="btn btn-dark">제품 구매</a>
				<a href="<%=request.getContextPath() %>/InsertCartCtrl?proNo=<%=vo.getProNo() %>" class="btn btn-dark">장바구니 넣기</a>
				<% if(sid.equals("admin")) { %>

...
public class Parsel {
	...
	private String pareslCompany;	//배송회사
	...
	public String getPareslCompany() {
		return pareslCompany;
	}
	public void setPareslCompany(String pareslCompany) {
		this.pareslCompany = pareslCompany;
	}
